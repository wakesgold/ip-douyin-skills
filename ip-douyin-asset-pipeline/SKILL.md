---
name: ip-douyin-asset-pipeline
description: IP asset library and AI drafting workflow for Douyin/TikTok business accounts, founder accounts, operator accounts, local-life stores, restaurant/store-owner accounts, consultants, service businesses, training businesses, and brand accounts. Use when the user asks to build an IP资产库, create a content ammunition library, turn founder/business/operator assets into Douyin scripts, draft short-video口播稿, design columns, rewrite from viral samples, review content with 七问原则/七宗罪驱动力, or create an AI出稿流水线 for an operating business account.
---
...
Build a reusable account asset library for a business, then use **viral structure × real assets × review checklist × data feedback** to create publishable Douyin content.
...
```text
可持续出稿能力 = IP资产厚度 × 爆款结构复用率 × 审稿迭代强度 × 数据复盘回流
```
...
For a normal drafting request, output:

1. **3 个标题**
2. **1 个 60 秒抖音口播稿**
3. **1 个 3 分钟深度版** if the topic needs depth
4. **1 条朋友圈/私域版本**
5. **封面字与评论引导**
6. **审稿说明**：命中的情绪驱动、使用的真实资产、需要补证据的地方
7. **后续需补的账号资产**：下一次应补齐的问题

## Domain References

- `references/asset-library.md`: startup table, three asset libraries, and required fields.
- `references/review-checklists.md`: 七问原则, 七宗罪驱动力, release scoring, and compliance checks.
- `references/local-life.md`: restaurant/store/local-life enhanced interview and content fields.
